...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[('EASY', 'Initié (8 paires)'), ('MEDIUM', 'Pirate (16 paires)'), ('HARD', 'Neural (32 paires)'), ('HARDCORE', 'Hardcore Regex (50 paires)')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('DEPOSIT', 'Dépôt via Stripe'), ('ENTRY_FEE', 'Inscription Tournoi'), ('REWARD', 'Gain de Compétition')], max_length=15)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wallet_history', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
